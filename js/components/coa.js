  ...
  template: `
    <div>
      ...
      <div class="help-section">
        <h5>Help</h5>
        <p><strong>Enable CoA:</strong> Enable CoA to allow the RADIUS server to dynamically change authorization attributes.</p>
        <p><strong>Client IP:</strong> Typically the RADIUS server IP (e.g., 192.168.1.10).</p>
        <p><strong>Server Key:</strong> Shared secret for CoA communications.</p>
        <p><strong>Port:</strong> Port number (default: 1700).</p>
      </div>
