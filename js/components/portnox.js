    ...
    template: `
        <div>
            ...
            <div class="help-section">
                ...
                <p><strong>Region:</strong> Select the Portnox Cloud region (US, EU, or Failover).</p>
                <p><strong>Shared Secret:</strong> Enter the shared secret provided by Portnox.</p>
                <p><strong>Use Same Secret for EU:</strong> Choose whether to use the same secret for both regions.</p>
                <p><strong>EU Shared Secret:</strong> If not using the same secret, provide the EU secret.</p>
