  ...
  template: `
    <div>
      ...
      <div class="help-section">
        <h5>Help</h5>
        <p><strong>Platform:</strong> Select the network vendor platform for which you want to generate the 802.1X configuration. This determines the syntax and available features (for example, IOS-XE supports IBNS 2.0, while ArubaOS uses AAA profiles).</p>
      </div>
