  ...
  template: `
    <div>
      ...
      <div class="help-section">
        <h5>Help</h5>
        <p><strong>Certificate Option:</strong> Choose whether to use a trustpoint (recommended) or manual certificate setup for RADSEC.</p>
        <p><strong>Trustpoint Name:</strong> Enter the name of the trustpoint (e.g., PORTNOX-CA) for TLS authentication.</p>
      </div>
