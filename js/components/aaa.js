  ...
  template: `
    <div>
      ...
      <div class="help-section">
        <h5>Help</h5>
        <p><strong>AAA Model:</strong> Enable AAA (new-model) for enhanced authentication. This is required for 802.1X on most platforms.</p>
        <p><strong>Authentication Method:</strong> Choose the authentication method (Local, RADIUS, TACACS+, or TACACS+ and RADIUS).</p>
        <p><strong>Authorization Method:</strong> Select the method for user authorization.</p>
        <p><strong>Accounting Method:</strong> Configure accounting to track user activity.</p>
        <p><strong>Session ID:</strong> Use a common or unique session ID. 'Common' is typically recommended.</p>
