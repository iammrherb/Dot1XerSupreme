  ...
  template: `
    <div>
      ...
      <div class="help-section">
        <h5>Help</h5>
        <p><strong>Enable Device Tracking:</strong> Enable tracking of devices (IP-to-MAC mapping) on access ports and trunk links.</p>
        <p><strong>Tracking Mode:</strong> Choose Auto-Source for automatic detection or Manual for custom configuration.</p>
        <p><strong>Access Port Policy:</strong> Enable to apply tracking on access ports.</p>
        <p><strong>Access Policy Name:</strong> Name your access policy (e.g., IP-TRACKING).</p>
        <p><strong>Address Limit:</strong> Maximum number of addresses per port (default: 4).</p>
        <p><strong>Lifetime:</strong> Lifetime of tracking entries in seconds (default: 30).</p>
        <p><strong>Trunk Port Policy:</strong> Enable to apply tracking on trunk ports.</p>
        <p><strong>Trunk Policy Name:</strong> Name your trunk policy (e.g., DISABLE-IP-TRACKING).</p>
      </div>
