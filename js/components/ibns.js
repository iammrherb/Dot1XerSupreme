    ...
    template: `
        <div>
            ...
            <div class="help-section">
                <h5>Help</h5>
                <p><strong>IBNS Mode:</strong> Choose between High Security (strict policies) or Low Impact (more permissive). High Security is recommended.</p>
                <p><strong>Policy Map Name:</strong> Name of the IBNS policy map (e.g., DOT1X_MAB_POLICY).</p>
                <p><strong>Enable Templates:</strong> Enable to use predefined templates for open and closed authentication.</p>
