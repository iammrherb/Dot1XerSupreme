  ...
  template: `
    <div>
      ...
      <div class="help-section">
        <h5>Help</h5>
        <p><strong>IBNS Mode:</strong> Choose between High Security (strict) and Low Impact modes.</p>
        <p><strong>Policy Map Name:</strong> Enter the name of your IBNS policy map (e.g., DOT1X_MAB_POLICY).</p>
        <p><strong>Enable Templates:</strong> Decide whether to use interface templates for open and closed modes.</p>
